...
class ReadWea:
    ...
    def histWea(self,lon,lat):
        ...
        self.SolRad = self.readValue(lon,lat,self.year1,"日射量") # 改為(MJ/m2) ,原先為 (w/m2)
...
class TemperatureHr:
    ...
    def Hourly(self,day_leng,tempList,solRad):
        ...
        self.WATACT = solRad/daylength/3600
...
if __name__ == "__main__" : 
    ...
    data_Hour = r'F:\HourWea\G2F820_item_hour_2000to2021.csv'
    data_daly = r'F:\HourWea\TARI_all.csv'
